...
docker buildx bake                         # uses VERSION=2.1.0 default
docker buildx bake --set "*.VERSION=2.1.0" # explicit version
VERSION=2.1.0 docker buildx bake --push    # build and push all tags
```
